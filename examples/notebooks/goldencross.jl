...
# ╔═╡ 744a9a00-fdb8-11ee-24f7-abec1248efa4
begin
	using Dates
	using Lucky
	using Rocket
...
# ╔═╡ 025d8b01-5b9e-4765-85c7-aba37019d08b
md"""# Lucky.jl - Goldencross strategy example
...
This makes [Lucky.jl](https://github.com/oliviermilla/Lucky.jl)  very powerful to develop, extend and integrate systems incrementally, from what could be a very simple R&D code to production."""

# ╔═╡ 6e36fded-76b8-48af-bc16-98a405e2678f
md"""## Get data"""

# ╔═╡ 44eb8f74-167a-41f1-b9fe-78bb2ff9171a
begin
	symbol = :AAPL
...
# ╔═╡ 7fcc7b07-0e9d-45ea-bb47-0f128940ad59
md"""## Plot data"""

# ╔═╡ 844bc160-2001-487a-91fe-9bb6c3348938
plot(data[:Close])

# ╔═╡ 487e1c01-f5c7-415b-8df2-569d2228a6d6
# plot(data[[:Open, :High, :Low, :Close]], seriestype = :candlestick)

# ╔═╡ fa67c8f0-7f22-4a90-82a6-30e92d79d7c5
md"""## Create the Instruments"""

# ╔═╡ 273a4278-d49d-43d7-b1b4-42fdc7d5c4dd
begin
	cash = Cash(:USD)
...
# ╔═╡ 0c3b734d-4f13-4bfe-9a65-fec7d57a0dc1
md"""## Create the feeds where each block submits or reads new data (pub/sub)"""

# ╔═╡ 2854ef66-cda9-4732-a4a7-4a2992a0792b
begin
...
# ╔═╡ fb53e190-9c85-4c68-adf1-24752db93f14
md"""## Iterate the data (as if a live feed)
Map the data to quotes of the above stock instrument
Multicast to the quotes feed so any actor can subscribe"""

# ╔═╡ 8de798eb-b767-4443-844c-a0904329b97a
begin
...
# ╔═╡ 7a056246-f28d-4d38-b728-3f7f7f3b3fba
md"""## Write the strategy"""

# ╔═╡ 6b67f756-b9c2-4bfe-9389-982a41aaddd1
begin
...
# ╔═╡ 3ff36bd8-b479-494b-978b-f14f122a9c7e
begin
...
Lucky = "091b6c57-2055-4743-a613-81d9bc5174d5"
...
manifest_format = "2.0"
project_hash = "7f4f63d2194631a92dd84d1712cdf4d131ee42ce"
...
[[deps.Lucky]]
deps = ["Dates", "Rocket", "Statistics", "UUIDs"]
git-tree-sha1 = "dcff94851f80b3db39f072437537a7c833301501"
uuid = "091b6c57-2055-4743-a613-81d9bc5174d5"
version = "0.3.3"

    [deps.Lucky.extensions]
    DydxV3Ext = "DydxV3"
...
[[deps.TimeSeries]]
deps = ["Dates", "DelimitedFiles", "DocStringExtensions", "PrettyTables", "RecipesBase", "Reexport", "Statistics", "Tables"]
git-tree-sha1 = "bd810d088a8ab8091172658a8d33cbc7699edc1a"
